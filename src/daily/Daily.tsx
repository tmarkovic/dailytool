...
import { addNames, removeName, participantsSelector } from './reducer'

import Header from "./Header";
import Footer from "./Footer";
import { setDuration } from "../time/reducer";
      ...
      <div className="container mx-auto w-full flex flex-col h-full items-center">
        {names.length ? (
          ...
          <div className="flex flex-row my-36 mb items-center place-items-center flex-shrink">
            ...
            />
            <h1 className="capitalize text-9xl"><span className="text-error block text-xl">ON AIR:</span>{current.name}</h1>
          </div>
        ) : null}
